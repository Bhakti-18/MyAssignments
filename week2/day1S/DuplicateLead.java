...
public class DuplicateLead {
	...
	public static void main(String[] args) {
	   ...
	   // driver.findElement(By.className("decorativeSubmit")).sendKeys(Keys.ENTER);
	    ...
	    System.out.println("This is the title of view lead"  +driver.getTitle());  
	    ...
	    FirstName.clear();
	    driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Aniruddha");
	    
	    driver.findElement(By.name("submitButton")).click();
	    
	    System.out.println("The is the title of duplicate lead" +driver.getTitle());
	}
